...
metadata {
    ...
    tiles(scale: 2) {
        ...
        standardTile("openAll", "device.openAll", width: 2, height: 2, inactiveLabel: false, decoration: "flat") {
				state "Closed", label: "OPEN ALL", action: "openAll", icon: "", backgroundColor: "#BABFC6"
				state "Open", label: "OPEN ALL", action: "openAll", icon: "", backgroundColor: "#BABFC6"
		}
        standardTile("closeAll", "device.closeAll", width: 2, height: 2, inactiveLabel: false, decoration: "flat") {
				state "Closed", label: "CLOSE ALL", action: "closeAll", icon: "", backgroundColor: "#BABFC6"
				state "Open", label: "CLOSE ALL", action: "closeAll", icon: "", backgroundColor: "#BABFC6"
		}
